...
<div class="container" style="max-width: 700px;">
    <div class="mb-4">
        <h3 style="color: #0d5c47; font-weight: 700;"><i class="bi bi-plus-circle me-2"></i>Tambah Koleksi Buku Baru</h3>
        <p class="text-muted">Isi data buku dengan lengkap di bawah ini</p>
    </div>
    ...
    <div class="card card-form p-4 md-5">
        <form action="/buku/simpan" method="post">
            ...
            <div class="mb-3">
                ...
                <input type="text" name="isbn" class="form-control py-2 <?= session('errors.isbn') ? 'is-invalid' : '' ?>" value="<?= old('isbn') ?>" placeholder="Contoh: 9786020000001">
            ...
            <div class="mb-3">
                ...
                <input type="text" name="judul" class="form-control py-2 <?= session('errors.judul') ? 'is-invalid' : '' ?>" value="<?= old('judul') ?>" placeholder="Masukkan nama judul buku">
            ...
            <div class="mb-3">
                ...
                <input type="text" name="penulis" class="form-control py-2 <?= session('errors.penulis') ? 'is-invalid' : '' ?>" value="<?= old('penulis') ?>" placeholder="Nama pengarang atau penulis">
            ...
            <div class="row">
                <div class="col-md-6 mb-4">
                    ...
                    <input type="number" name="tahun" class="form-control py-2 <?= session('errors.tahun') ? 'is-invalid' : '' ?>" value="<?= old('tahun') ?>" placeholder="Tahun angka">
                ...
                <div class="col-md-6 mb-4">
                    ...
                    <input type="number" name="stok" class="form-control py-2 <?= session('errors.stok') ? 'is-invalid' : '' ?>" value="<?= old('stok') ?>" placeholder="Jumlah unit">
            ...
            <div class="d-flex gap-2 justify-content-end mt-2">
                ...
                <button type="submit" class="btn btn-mint px-4 py-2"><i class="bi bi-check-lg me-1"></i>Simpan Buku</button>
            </div>
        </form>
    </div>
</div>
